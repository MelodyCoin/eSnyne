...
HD_PWD='C:/Users/Solstice/Documents/eSnyne_WorkSpace/eSnyne 1.1/eSnyne 1.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eSnyne_core_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eSnyne_core_wrapper.tcl -notrace
